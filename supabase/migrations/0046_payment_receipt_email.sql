-- PAY-06: a branded receipt email, sent to the customer automatically once
-- a payment is actually verified/counted (immediately for Stripe; only
-- after Finance verifies a bank transfer — see 0044). Adds a 12th fixed
-- template key, same additive-redefine pattern as every prior
-- email_templates change: 0020, 0021, 0030, 0036, 0038.
